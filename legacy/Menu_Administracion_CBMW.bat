...
echo ============================================================
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "Block"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU
...
echo ============================================================
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "CleanBrowsers"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU
...
echo ============================================================
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "Shortcuts"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU
...
echo ============================================================
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "Unblock"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU

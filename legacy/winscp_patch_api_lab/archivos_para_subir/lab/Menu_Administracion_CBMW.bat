...
echo  [5] Crear Accesos Directos (Plataforma DIA + Sistemas CBMW)
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "Audit"
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0aplicar_bloqueo_lab.ps1"
if %errorlevel% neq 0 goto ERROR_TRAP
echo.
pause
goto MENU
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0ejecutar_limpieza_lab.ps1"
if %errorlevel% neq 0 goto ERROR_TRAP
echo.
pause
goto MENU
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "CleanFiles"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0crear_acceso_dia.ps1"
if %errorlevel% neq 0 goto ERROR_TRAP
echo.
pause
goto MENU
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0desbloquear_lab.ps1"
if %errorlevel% neq 0 goto ERROR_TRAP
echo.
pause
goto MENU
...
echo ============================================================
powershell -ExecutionPolicy Bypass -File "%~dp0agente_cbmw_global.ps1" -Interactive -Action "Force"
if %errorlevel% neq 0 goto ERROR_TRAP
goto MENU
...
if exist "%~dp0lab_log.txt" (
    ...
    echo ------------------------------------------------------------
    powershell -Command "Get-Content -Path '%~dp0lab_log.txt' -Tail 15"
    echo ------------------------------------------------------------
)
echo.
